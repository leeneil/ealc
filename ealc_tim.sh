...
python3 buildLabelCSV.py --path1-data data --path2-data wikipedia/samples_256 --num-data 30000
...
echo "------------------------ trainModel.py ------------------------"
python3 trainModel.py --num-train-steps 1500 --batch-size 100 --print-steps 100
