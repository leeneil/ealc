...
# Default data paths.
DEFAULT_LABEL_CSV = os.path.join('data','labels-map.csv')
...
class TFRecordsConverter(object):
    ...
    def __init__(self, labels_csv, output_dir,
        ...
        self.filenames, self.labels = self.process_image_labels(labels_csv)
        # Counter for total number of images processed.
        self.counter = 0

    def process_image_labels(self, labels_csv):
    ...
    def write_tfrecords_file(self, output_path, indices):
        ...
        for i in indices:
            ...
            example = tf.train.Example(features=tf.train.Features(feature={
                ...
                'data/image': _bytes_feature(tf.compat.as_bytes(im_data))}))
