...
/usr/bin/python3 buildLabelCSV.py --path1-data data --path2-data wikipedia/samples_128 --num-data 100
# --test-percentage: the percentage for test set 
echo "------------------------ buildTFRecord.py ------------------------"
/usr/bin/python3 buildTFRecord.py --test-percentage 0.2
...
echo "------------------------ trainModel.py ------------------------"
/usr/bin/python3 trainModel.py --num-train-steps 100 --batch-size 10 --print-steps 10